...
//adding the images and attributes to the products
   ...
   */
  //
  //appending the description to the product object
...
//iterating product array and adding it into the cart
